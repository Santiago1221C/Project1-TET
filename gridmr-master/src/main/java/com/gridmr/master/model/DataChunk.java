...
public class DataChunk {
    ...
    public DataChunk(String chunkId, String jobId, String originalFileName, long startOffset, long endOffset) {
    ...
    public String getSummary() {
        return String.format("Chunk %s: %s bytes (%.2f MB) from %s", chunkId, sizeBytes, getSizeMB(), originalFileName);
    }
}