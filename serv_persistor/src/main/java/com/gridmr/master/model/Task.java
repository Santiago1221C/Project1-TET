...
/**
 * Representa una tarea individual Map o Reduce
 * Cada tarea se ejecuta en un worker específico
 */
public class Task {
    ...
    // Verifica si la tarea está asignada a un worker
    public boolean isAssigned() {
        return workerId != null && !workerId.isEmpty();
    }
    
    // Verifica si la tarea es de tipo Map
    public boolean isMapTask() {
        return type == TaskType.MAP;
    }
    
    // Verifica si la tarea es de tipo Reduce
